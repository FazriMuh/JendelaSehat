    ...
    <div class="st-page-heading st-size-md st-dynamic-bg" data-src="assets/img/hero-bg6.jpg">
      <div class="container">
        <div class="st-page-heading-in text-center">
          <h1 class="st-page-heading-title">Hospitals in Bogor</h1>
          <div class="st-page-heading-subtitle">Find the nearest hospitals</div>
        </div>
      </div>
    </div><!-- .st-page-heading -->
                    ...
                    <div class="background-white thum-hover box-shadow hvr-float full-width margin-bottom-45px">
                        ...
                        <div class="padding-lr-25px padding-tb-50px">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-4 text-right"><a href="<?PHP echo base_url()?>hospital/detail?id=<?PHP echo $row->id_hospital?>" class="text-blue"><i class="far fa-hospital"></i> Hospital</a></div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>

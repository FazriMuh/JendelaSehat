...
<body>
  ...
  <div class="st-content">
      ...
      <div class="st-hero st-style1">
        <div class="container">
          <div class="st-hero-text">
            ...
            <div class="st-hero-subtitle">Menyediakan lokasi vaksinasi Covid-19 yang tersebar di kota Bogor. <br>
            Efektifitas dan efesiensi waktu menjadi tujuan utama kami</div>
          </div>
        </div>
        <div class="st-hero-social-group">
          <div class="container">
            <ul class="st-social-btn st-style1 st-mp0">
              ...
              <li><a href="https://www.instagram.com/jendela.sehat/"><i class="fab fa-pinterest-square"></i></a></li>
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              <div class="st-iconbox-icon st-purple-box">
                <img src="assets/img/eficiency.png" alt="Eficiency" width="60px">
              </div>
              <h2 class="st-iconbox-title">Efisiensi</h2>
              <div class="st-iconbox-text">Menghemat waktu lebih banyak dan secara cepat dalam pencarian lokasi vaksinasi Covid-19 di kota Bogor</div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              <div class="st-iconbox-icon st-green-box">
                <img src="assets/img/efective.png" alt="Efective" width="60px">
              </div>
              <h2 class="st-iconbox-title">Efektivitas</h2>
              <div class="st-iconbox-text">Secara tepat guna memberikan informasi lokasi vaksin dan juga rumah sakit yang tersebar di kota Bogor</div>
            </div>
            <div class="st-height-b0 st-height-lg-b30"></div>
          </div><!-- .col -->
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              <div class="st-iconbox-icon st-red-box">
                <img src="assets/img/news.png" alt="News" width="60px">
              </div>
              <h2 class="st-iconbox-title">Berita Terbaru</h2>
              <div class="st-iconbox-text">Memberikan berita-berita terkini mengenai dunia kesehatan dan artikel mengenai Covid-19</div>
            </div>
            <div class="st-height-b0 st-height-lg-b30"></div>
          </div><!-- .col -->
        </div>
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter">64774</h2>
                  <div class="st-funfact-title">Terkonfirmasi</div>
                </div>
              ...
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter">63914</h2>
                  <div class="st-funfact-title">Sembuh</div>
                </div>
                <div class="st-height-b30 st-height-lg-b30"></div>
              </div><!-- .col -->
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter">306</h2>
                  <div class="st-funfact-title">Isolasi</div>
                </div>
                <div class="st-height-b30 st-height-lg-b30"></div>
              </div><!-- .col -->
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter">554</h2>
                  <div class="st-funfact-title">Meninggal</div>
                </div>
                <div class="st-height-b30 st-height-lg-b30"></div>
              </div><!-- .col -->
            </div>
          ...
          <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
            <div class="st-video-block st-style1 st-zoom">
              ...
              <a href="https://www.youtube.com/embed/IecDtqXUZf0?autoplay=1"
    ...
    <section id="department">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Pencegahan Covid-19</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="assets/img/icons/4.png" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
          <div class="st-section-heading-subtitle">Ayo, Lindungi diri dan keluarga dengan melaksanakan protokol kesehatan dalam pencegahan Covid-19.</div>
        </div>
          ...
          <ul class="st-tab-links st-style1 st-mp0">
            <li class="st-tab-title active ">
              <a href="#Crutches" class="st-blue-box">
                <img src="assets/img/mask-icon2.png" alt="icon">
                <span>Masker</span>
              </a>
            </li>
            <li class="st-tab-title">
              <a href="#X-ray" class="st-red-box">
                <img src="assets/img/hand-wash-icon.png" alt="icon">
                <span>Cuci tangan</span>
              </a>
            </li>
            <li class="st-tab-title">
              <a href="#Pulmonary" class="st-green-box">
                <img src="assets/img/vaccine-icon.png" alt="icon">
                <span>Vaksin</span>
              </a>
            </li>
            <li class="st-tab-title">
              <a href="#Cardiology" class="st-dip-blue-box">
                <img src="assets/img/distance-icon.png" alt="icon">
                    ...
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                          <h2 class="st-imagebox-title">Ayo kenakan <span>Masker</span></h2>
                          <h4 class="st-imagebox-subtitle">Masker merupakan penghalang sederhana yang bisa membantu mencegah percikan pernapasan yang berisi virus dari orang lain masuk ke dalam tubuh.</h4>
                          <div class="st-imagebox-text">Covid-19 bisa menyebar dengan mudah dari satu orang ke orang lain, terutama melalui droplet atau percikan dari saluran pernapasan. Hal itu bisa terjadi ketika orang yang terinfeksi batuk, bersin, berbicara, berteriak, atau bernyanyi, lalu droplet yang keluar terhirup melalui mulut atau hidung orang lain di sekitarnya.</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                          <h2 class="st-imagebox-title">Selalu <span>Mencuci tangan</span></h2>
                          <h4 class="st-imagebox-subtitle">Rutin mencuci tangan hingga bersih adalah salah satu protokol kesehatan yang cukup efektif untuk mencegah penularan virus corona. </h4>
                          <div class="st-imagebox-text">Untuk hasil yang maksimal, kamu disarankan untuk mencuci tangan setidaknya selama 20 detik beberapa kali sehari, terutama saat; sebelum memasak atau makan, menggunakan kamar mandi, menutup hidung saat batuk atau bersin.                          </div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                          <h2 class="st-imagebox-title">Ayo <span>Vaksin!</span></h2>
                          <h4 class="st-imagebox-subtitle">Pemerintah saat ini sedang sangat serius dalam menanggulangi pandemi Covid-19. </h4>
                          <div class="st-imagebox-text">PPKM darurat pada tanggal 3 Juli 2021 yang lalu, hingga melakukan upaya import vaksin Covid-19 yang dipergunakan untuk seluruh masyarakat Indonesia guna mengejar angka Herd Immunity  yaitu di angka 70%.</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                          <h2 class="st-imagebox-title">Selalu <span>Jaga jarak!</span></h2>
                          <h4 class="st-imagebox-subtitle">Protokol kesehatan jaga jarak dimuat dalam Keputusan Menteri Kesehatan RI dalam “Protokol Kesehatan Bagi Masyarakat di Tempat dan Fasilitas Umum Dalam Rangka Pencegahan dan Pengendalian COVID-19.”
                          </h4>
                          <div class="st-imagebox-text">Di sana disebutkan, menjaga jarak minimal 1 meter dengan orang lain untuk menghindari terkena droplets dari orang yang bicara, batuk, atau bersin, serta menghindari kerumunan, keramaian, dan berdesakan.</div>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <section id="doctors">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Meet our Team</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="assets/img/icons/4.png" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
          <div class="st-section-heading-subtitle">We care about your health, we do something to make your lifestyle better and healthier. <br>
          ...
          <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
            ...
            <div class="slick-wrapper">
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="assets/img/Aji.jpg" alt="" class="st-zoom-in">
                  ...
                  <div class="st-member-meta">
                    <div class="st-member-meta-in">
                      <h3 class="st-member-name"><a href="doctor-profile.html">Mhd. Fazri Nahar</a></h3>
                      <div class="st-member-designation">Project Leader</div>
                    </div>
                  </div>
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="assets/img/Ramzy.jpg" alt="member2" class="st-zoom-in">
                    <a class="st-doctor-link" href="doctor-profile.html"><i class="fas fa-link"></i></a>
                    <div class="st-member-social-wrap">
                      <img src="assets/img/shape/member-shape.svg" alt="shape" class="st-member-social-bg">
                      <ul class="st-member-social st-mp0">
                  ...
                  <div class="st-member-meta">
                    <div class="st-member-meta-in">
                      <h3 class="st-member-name"><a href="doctor-profile.html">Ramzy Syafiq I</a></h3>
                      <div class="st-member-designation">Developer</div>
                    </div>
                  </div>
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="assets/img/Uti.jpg" alt="member3" class="st-zoom-in">
                    <a class="st-doctor-link" href="doctor-profile.html"><i class="fas fa-link"></i></a>
                    <div class="st-member-social-wrap">
                      <img src="assets/img/shape/member-shape.svg" alt="shape" class="st-member-social-bg">
                      <ul class="st-member-social st-mp0">
                  ...
                  <div class="st-member-meta">
                    <div class="st-member-meta-in">
                      <h3 class="st-member-name"><a href="doctor-profile.html">Putri Maulani R</a></h3>
                      <div class="st-member-designation">Designer</div>
                    </div>
                  </div>
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="assets/img/Salsa.jpg" alt="member4" class="st-zoom-in">
                    <a class="st-doctor-link" href="doctor-profile.html"><i class="fas fa-link"></i></a>
                    <div class="st-member-social-wrap">
                      <img src="assets/img/shape/member-shape.svg" alt="shape" class="st-member-social-bg">
                      <ul class="st-member-social st-mp0">
                  ...
                  <div class="st-member-meta">
                    <div class="st-member-meta-in">
                      <h3 class="st-member-name"><a href="doctor-profile.html">Salsabila Chairunnisa</a></h3>
                      <div class="st-member-designation">Copywriter</div>
                    </div>
                  </div>
                </div>
              </div><!-- .slick-slide-in -->
    ...
    <section>
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          ...
          <div class="st-section-heading-subtitle">Apa kata mereka tentang Jendela Sehat?</div>
        </div>
        <div class="st-height-b40 st-height-lg-b40"></div>
      </div>
      <div class="container">
                ...
                <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                  <div class="st-testimonial-info">
                    ...
                    <div class="st-testimonial-meta">
                      <h4 class="st-testimonial-name">Irgi Alif F</h4>
                      <div class="st-testimonial-designation">Student</div>
                    </div>
                  </div>
                  <div class="st-testimonial-text">Informasi mengenai vaksinasi sangat membantu dan terupdate, karena informasi yang disajikan pada website Jendela Sehat selalu diperbarui setiap harinya.</div>
              ...
              <div class="slick-slide-in">
                <div class="st-testimonial st-style1">
                  <div class="st-testimonial-info">
                    ...
                    <div class="st-testimonial-meta">
                      <h4 class="st-testimonial-name">Ibrohim Hanifa M</h4>
                      <div class="st-testimonial-designation">Student</div>
                    </div>
                  </div>
                  <div class="st-testimonial-text">Informasi mengenai rumah sakit sangat mempermudah bagi masyarakat yang masih kebingungan mengenai rumah sakit dengan lokasi paling dekat dengan tempat tinggalnya.</div>
                  <div class="st-quote"><i class="fas fa-quote-right"></i></div>
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-testimonial st-style1 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                  <div class="st-testimonial-info">
                    ...
                    <div class="st-testimonial-meta">
                      <h4 class="st-testimonial-name">M Luthfi</h4>
                      <div class="st-testimonial-designation">Student</div>
                    </div>
                  </div>
                  <div class="st-testimonial-text">Berita-berita mengenai kesehatan yang disajikan merupakan berita-berita terupdate dan juga sangat informatif.</div>
                  <div class="st-quote"><i class="fas fa-quote-right"></i></div>
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
            ...
            <div class="st-accordian-wrap">
              <div class="st-accordian active ">
                <div class="st-accordian-title">
                  Bagaimana jika saya ingin mencari vaksin terdekat?
                  <span class="st-accordian-toggle fa fa-angle-down"></span>
                </div>
                <div class="st-accordian-body">Anda dapat mengunjungi laman kami kemudian klik menu vaksinasi, website akan menampilkan daftar tempat vaksinasi beserta alamat dan jenis vaksin yang disediakan, lalu anda dapat mencari tempat vaksinasi yang tersedia serta dekat dengan kediaman anda.
                </div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                <div class="st-accordian-title">
                  Nomor mana yang harus saya hubungi untuk memesan layanan home service?
                  <span class="st-accordian-toggle fa fa-angle-down"></span>
                </div>
                <div class="st-accordian-body">Anda dapat berkunjung ke halaman utama kami dan memilih menu vaksinasi, kemudian pilih layanan home service, kami akan mengarahkan anda langsung kepada website yang kemudian berisi form pemesanan layanan home service.</div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                <div class="st-accordian-title">
                  Bagaimana jika saya ingin melihat update tentang covid-19?
                  <span class="st-accordian-toggle fa fa-angle-down"></span>
                </div>
                <div class="st-accordian-body">Anda dapat mengunjungi laman kami kemudian klik menu Home pada bagian kanan atas  website, kemudian akan tersaji informasi terbaru mengenai Covid-19.</div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                <div class="st-accordian-title">
                  Bagaimana cara saya mengetahui rumah sakit terdekat dari tempat tinggal saya?
                  <span class="st-accordian-toggle fa fa-angle-down"></span>
                </div>
                <div class="st-accordian-body">Anda dapat mengunjungi laman kami kemudian klik menu Hospitals pada bagian kanan atas website. Anda dapat melihat daftar rumah sakit beserta alamat dari rumah sakit tersebut.</div>
              </div><!-- .st-accordian -->
              <div class="st-accordian">
                <div class="st-accordian-title">
                  Apa yang harus saya lakukan untuk melihat berita-berita kesehatan terbaru?
                  <span class="st-accordian-toggle fa fa-angle-down"></span>
                </div>
                <div class="st-accordian-body">Anda dapat mengunjungi laman kami kemudian klik menu Blog pada bagian kanan atas website, setelah itu website akan menampilkan informasi-informasi kesehatan terbaru.</div>
              </div><!-- .st-accordian -->
    ...
    <section class="st-news-letter-section st-dynamic-bg st-bg" data-src="assets/img/news-letter-bg.png">
      <div class="container">
        <div class="st-section-heading st-style1">
          ...
          <div class="st-section-heading-subtitle">Daftarkan email Anda untuk mendapatkan informasi dan berita terbaru dari kita.</div>
        </div>
        <div class="st-height-b40 st-height-lg-b40"></div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="st-news-letter">
              ...
              <div class="st-news-letter-number">(+62) - 821 2323 2022</div>
            </div>
          </div>
        </div>
      </div>
